            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="swiper-container theme-slider position-lg-absolute all-0">
                                    <div class="swiper-wrapper h-100">
                                        <div class="swiper-slide h-100">
                                            <img id="productImagePreview" class="rounded-1 fit-cover h-100 w-100" src="Static_access_manager/assets/img/products/1.jpg" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <input id="productImageInput" type="file" name="productImage" accept="image/*" required>
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="fs-3" name="productName" placeholder="Product Name" required>
                            ...
                            <input type="number" class="fs-3" name="productPrice" placeholder="Product Price" required>
                            <br>
                            <select class="form-select" name="productStatus" required>
                            ...
                            <div class="row">
                                <div class="col-auto pe-0">
                                    <div class="input-group input-group-sm" data-quantity="data-quantity">
                                        <button class="btn btn-sm btn-outline-secondary border-300" data-field="productQuantity" data-type="minus">-</button>
                                        <input class="form-control text-center" type="number" name="productQuantity" min="0" value="0" aria-label="Product Quantity" style="max-width: 50px" required />
                                        <button class="btn btn-sm btn-outline-secondary border-300" data-field="productQuantity" data-type="plus">+</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="overflow-hidden mt-4">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="tab-description" role="tabpanel" aria-labelledby="description-tab">
                                        <div class="mt-3">
                                            <textarea style="width: 800px; height: 200px" name="productDescription" placeholder="Product Description" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
