        ...
        <div class="content">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                    <form action="updatestaff" class="row g-3">
                        <div class="col-lg-10">
                            <label class="form-label" for="first-name">Full Name</label>
                            <input class="form-control" id="first-name" type="text" value="${staff.fullname}" readonly/>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input class="form-control" id="email2" type="text" value="${staff.phone_number}" readonly/>
                        </div>
                        <div class="col-lg-12">
                            <label class="form-label" for="email2">Address</label>
                            <input class="form-control" id="address" type="text" value="${staff.address}" readonly/>
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label" for="email2">Role</label>
                            <select name="role">
                                <c:forEach items="${listRole}" var="l">
                                    <option value="${l.rName}"
                                            <c:if test="${l.rName == staff.roleName}">selected</c:if>>${l.rName}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <label for="male">
                                <input type="radio" id="male" name="status" value="activate"
                                       <c:if test="${staff.status == true}">checked</c:if>> Activate
                            </label>
                            <label for="female">
                                <input type="radio" id="female" name="status" value="deactivate"
                        ...
                        <input name="sid" value="${staff.staffID}" hidden/>
                    </form>
                </div>
            </div>
        </div>
